<?php
/**
 * SETUP CHILD DATA | 1.0.0 | 210312 | functions.php
 *
 * @package      Setup Child
 * @author       Mark Corpuz
 * @since        1.0.0
...
function ea_child_theme_setup() {
	...
	include_once( get_stylesheet_directory() . '/inc/navigation-data.php' );
	...
	include_once( get_stylesheet_directory() . '/inc/site-footer-data.php' );
